...
const ForgotPasswordScreen: React.FC = () => {
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      const result = await passwordRecoveryService.sendPasswordResetEmail(
        ...
        <View style={[styles.mainCenterContainer]}>
          ...
          >
            ...
            >
              ...
              <Text
                style={[
                  styles.checkSpamText,
                  { color: BRAND_PRIMARY, marginBottom: 0 },
                ]}
              >
            ...
            <TouchableOpacity
              style={[
                ...
                { backgroundColor: BRAND_PRIMARY, marginTop: 20 },
              ]}
              onPress={handleBackToLogin}
              activeOpacity={0.8}
            >
            ...
            >
              <Text style={[styles.textButtonText, { color: BRAND_PRIMARY }]}>
        ...
        >
          <View style={styles.header}>
            ...
            <Text style={[styles.subtitle, { color: BRAND_GRAY }]}>
              Ingresa tu correo asociado y te enviaremos un enlace para
          ...
          <View style={styles.footer}>
            <Text style={[styles.footerText, { color: BRAND_GRAY }]}>
              ...
              <Text
                ...
                onPress={() => Linking.openURL("mailto:soporte@demo.com")}
              >
                Contactar Soporte
              </Text>
            </Text>
